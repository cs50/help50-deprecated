...
<?php
    ...
    */
    ...
    echo "Did you forget to \033[1m#include <stdio.h>\033[0m\033[33m (in which \033[1mprintf\033[0m\033[33m is declared) atop your file?\n";
    echo "\033[35m<3 <3 <3 <3 <3 <3 <3 <3\033[39m\n";
    echo "\033[39m";
